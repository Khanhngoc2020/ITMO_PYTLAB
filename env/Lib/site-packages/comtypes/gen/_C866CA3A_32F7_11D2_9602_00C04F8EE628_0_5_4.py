...
__all__ = [
    'SPPS_Noncontent', 'SAFTTrueSpeech_8kHz1BitMono',
    'SpUnCompressedLexicon', 'DISPID_SVEventInterests',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SRGCommit',
    'DISPID_SDKSetBinaryValue', 'DISPID_SLGetWords',
    'SpeechRegistryUserRoot', 'SASPause', 'DISPID_SRCEBookmark',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', '_SPAUDIOSTATE',
    'ISpeechPhraseProperty', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SOTSetId', 'SPEI_MIN_SR', 'DISPID_SOTGetStorageFileName',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SpeechObjectToken', 'DISPID_SOTRemove', 'ISpObjectToken',
    'SINoise', 'DISPID_SWFEChannels', 'SPBO_TIME_UNITS',
    'SPRECOGNIZERSTATUS', 'SPGRAMMARWORDTYPE', 'ISpeechBaseStream',
    'SAFTCCITT_uLaw_44kHzMono', 'ISpGrammarBuilder', 'SRAImport',
    'DISPID_SRGRules', 'ISpeechRecognizerStatus', 'SPEVENTSOURCEINFO',
    'SAFT11kHz8BitStereo', 'DISPID_SAFGetWaveFormatEx',
    'SGPronounciation', 'DISPID_SPIGetText', 'SVEAudioLevel',
    'DISPID_SPAPhraseInfo', 'DISPID_SVSInputSentenceLength',
    'ISpStreamFormat', 'ISpeechMemoryStream', 'SPPHRASERULE',
    ...
    'IInternetSecurityMgrSite', 'ISpeechAudioStatus', 'ISpPhraseAlt',
    'DISPID_SWFEFormatTag', 'DISPID_SLPs_NewEnum', 'SREAudioLevel',
    'SPSSuppressWord', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SRGCmdLoadFromFile', 'SRERecoOtherContext', 'SRTStandard',
    'SPINTERFERENCE_TOOFAST', 'SDTProperty', 'ISpeechRecoResult2',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SOTCDefault', 'SVP_16',
    'DISPID_SRCEInterference', 'DISPID_SLRemovePronunciation',
    'SPSHT_NotOverriden', 'SPPROPERTYINFO', 'SAFT48kHz8BitStereo',
    'DISPID_SRGDictationUnload', 'SRTAutopause',
    'DISPID_SDKEnumValues', 'SpeechCategoryVoices',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SPANumberOfElementsInResult',
    'DISPID_SPRuleEngineConfidence', 'ISpeechRecoResultTimes',
    'DISPID_SRAudioInput', 'UINT_PTR', 'ISpObjectWithToken',
    'SRSActiveAlways', 'DISPID_SGRSTText', 'SAFTCCITT_ALaw_8kHzMono',
    'SDKLLocalMachine', 'ISpeechGrammarRuleStateTransition',
    'SPSModifier', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SOTCEnumerateTokens', 'SAFTNonStandardFormat',
    'DISPID_SPRuleName', 'SPADAPTATIONRELEVANCE', 'SRCS_Enabled',
    'DISPID_SGRInitialState', 'SVP_15', 'DISPID_SPPValue',
    'DISPID_SVESentenceBoundary', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SGRName', 'SPAS_RUN', 'ISpMMSysAudio', 'SPSMF_UPS',
    'SPAUDIOBUFFERINFO', 'DISPID_SPIStartTime', 'ISpeechVoiceStatus',
    'SPSNotOverriden', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SPWT_PRONUNCIATION', 'SPPS_RESERVED4', 'SDTAll',
    'SVEEndInputStream', 'SRAExport', 'DISPID_SVSLastResult',
    'SDTRule', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SABufferNotifySize', 'DISPID_SGRSTsItem',
    'SGRSTTWildcard', 'DISPID_SLWLangId', 'SPVPRIORITY',
    'DISPID_SRRDiscardResultInfo', 'SpMMAudioOut',
    'SDKLCurrentConfig', 'SRAORetainAudio',
    'SpPhoneticAlphabetConverter', 'SPXRO_Alternates_SML',
    'SpeechAudioFormatGUIDText', 'SPWAVEFORMATTYPE',
    'DISPID_SPIRetainedSizeBytes', 'SSFMOpenForRead', 'SDTAlternates',
    'SPEI_PROPERTY_STRING_CHANGE', 'SpeechRecoEvents',
    'DISPID_SRSAudioStatus', 'DISPID_SDKDeleteKey', 'SPCS_ENABLED',
    'DISPID_SFSClose', 'ISpRecoGrammar', 'DISPID_SGRSTNextState',
    'DISPID_SRCSetAdaptationData', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SLPSymbolic', 'eWORDTYPE_ADDED', 'SITooFast',
    'eLEXTYPE_PRIVATE2', 'SPEI_START_SR_STREAM', 'SPPHRASE',
    'SPEVENTENUM', 'DISPID_SOTDisplayUI', 'SPINTERFERENCE',
    'DISPIDSPTSI_SelectionLength', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SAFT48kHz16BitStereo',
    'SPRST_INACTIVE', 'SpeechCategoryPhoneConverters', 'SPAO_NONE',
    'DISPID_SPRuleParent', 'STSF_CommonAppData', 'SPSERIALIZEDPHRASE',
    'SpeechGrammarState', 'DISPID_SAEventHandle',
    'DISPID_SVSInputSentencePosition', 'DISPID_SGRSAddWordTransition',
    'SWPUnknownWordPronounceable', 'DISPID_SRGDictationLoad',
    'eLEXTYPE_PRIVATE11', 'SPPHRASEREPLACEMENT',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SPEs_NewEnum',
    'DISPID_SGRSTRule', 'eLEXTYPE_PRIVATE5', 'SPSEMANTICFORMAT',
    'SPPS_Modifier', 'SPAR_High', 'DISPID_SRGIsPronounceable',
    'SpeechRecognitionType', 'SpTextSelectionInformation',
    'SPEI_UNDEFINED', 'SECFIgnoreCase', 'SpeechLexiconType',
    'eLEXTYPE_PRIVATE15', 'DISPID_SVEVoiceChange',
    'DISPID_SPPEngineConfidence', 'DISPID_SVDisplayUI',
    'SPGS_DISABLED', 'DISPID_SPPs_NewEnum', 'SpPhraseInfoBuilder',
    'SP_VISEME_0', 'DISPID_SVVolume', 'DISPID_SPAsCount', 'SVP_17',
    'DISPID_SRCBookmark', 'DISPID_SGRSAddSpecialTransition',
    'ISpeechObjectToken', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SpeechAudioBufferInfo', 'SpeechRunState',
    'DISPID_SpeechPhraseRules', 'DISPID_SGRs_NewEnum',
    'ISpRecoContext', 'DISPID_SASState', 'SPCATEGORYTYPE',
    'SpSharedRecoContext', 'SpeechVoiceEvents', 'SAFT44kHz8BitStereo',
    'SP_VISEME_18', 'SPBO_AHEAD', 'STCInprocServer',
    'DISPID_SRGCmdSetRuleState', 'tagSPTEXTSELECTIONINFO',
    'SpeechRetainedAudioOptions', 'SP_VISEME_6', 'SPWT_DISPLAY',
    'eLEXTYPE_RESERVED7', 'SVP_2', 'DISPID_SRRSpeakAudio',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SPPParent',
    'SpeechTokenKeyUI', 'SPVISEMES', 'DISPID_SPRFirstElement',
    'SpObjectTokenCategory', 'SpLexicon',
    'SSSPTRelativeToCurrentPosition', 'SPEI_RECOGNITION',
    'SP_VISEME_17', 'DISPID_SOTDataKey', 'SGLexicalNoSpecialChars',
    'ISpVoice', 'DISPID_SPAStartElementInResult',
    'DISPID_SpeechRecognizerStatus', 'ISpPhoneticAlphabetSelection',
    'DISPID_SVEBookmark', 'ISpRecoGrammar2', 'ISequentialStream',
    'DISPID_SRIsUISupported', 'SP_VISEME_2',
    'DISPID_SpeechLexiconProns', 'SPAUDIOSTATE',
    'DISPID_SpeechPhoneConverter', 'DISPID_SLWsItem',
    'SPEI_TTS_PRIVATE', 'DISPID_SVSInputWordPosition',
    'IInternetSecurityManager', 'SVPOver', 'SWTDeleted',
    'SpeechTokenKeyFiles', 'DISPID_SABIMinNotification',
    'SpeechEngineProperties', 'DISPID_SOTCGetDataKey',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SVSLastBookmark',
    'STCRemoteServer', 'SPAR_Low', 'SpObjectToken', 'SPEI_MAX_SR',
    'DISPID_SOTCategory', 'SECLowConfidence', 'ISpeechCustomStream',
    'SpWaveFormatEx', 'SRTExtendableParse', 'SDTLexicalForm',
    'SAFT11kHz16BitMono', 'DISPID_SVSInputWordLength',
    'DISPID_SpeechMemoryStream', 'SpInprocRecognizer',
    'DISPID_SRSetPropertyString', 'DISPID_SVGetProfiles',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SVStatus',
    'SpeechEmulationCompareFlags', 'SPEI_HYPOTHESIS',
    'SPEI_RESERVED6', 'DISPID_SRGSetWordSequenceData',
    'SAFTGSM610_22kHzMono', 'SPSMF_SAPI_PROPERTIES', 'SPPS_RESERVED2',
    'DISPID_SpeechPhraseElements', 'DISPID_SGRsAdd',
    'STCInprocHandler', 'SPEI_RESERVED2', 'DISPID_SRCEHypothesis',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SRRGetXMLResult',
    'DISPID_SPPsItem', 'SGSExclusive', 'SAFTCCITT_uLaw_22kHzStereo',
    'SPSHT_EMAIL', 'SPFM_OPEN_READONLY', 'SVP_9',
    'DISPID_SVGetAudioInputs', 'DISPID_SPPConfidence', 'SPFILEMODE',
    'SECHighConfidence', 'SVP_12', 'SPWF_INPUT', 'IStream',
    'SPEI_RESERVED3', 'SVP_21', 'DISPID_SVEStreamEnd',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPSHORTCUTPAIRLIST',
    'DISPID_SpeechPhraseProperty', 'DISPID_SPERetainedSizeBytes',
    'ISpeechRecoContext', 'DISPID_SLPsCount', 'DISPID_SGRAddState',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPSInterjection',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SASFreeBufferSpace',
    'SPBO_NONE', 'IEnumSpObjectTokens',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SRCRequestedUIType',
    'DISPID_SRCRetainedAudio', 'IEnumString', 'SVSFParseMask',
    'SPEI_ADAPTATION', 'DISPID_SRRSaveToMemory', 'DISPID_SPAsItem',
    'SPRST_ACTIVE', 'DISPID_SRCEPhraseStart',
    'SpeechSpecialTransitionType', 'SVSFParseSapi',
    'DISPID_SpeechObjectTokenCategory',
    'SpeechDictationTopicSpelling', 'SITooQuiet',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SpeechVoice',
    'SpeechAudioFormatGUIDWave', 'DISPID_SVEEnginePrivate',
    'SFTSREngine', 'DISPID_SOTId', 'SPINTERFERENCE_NOSIGNAL',
    'SPFM_NUM_MODES', 'DISPID_SpeechRecoContextEvents',
    'eLEXTYPE_USER', 'DISPID_SGRSRule', 'SpAudioFormat',
    'DISPIDSPTSI_SelectionOffset', 'eLEXTYPE_RESERVED6',
    'SDKLDefaultLocation', 'ISpEventSource',
    'DISPID_SpeechPhraseReplacements', 'SPPS_Interjection',
    'SPEI_SENTENCE_BOUNDARY', 'ISpeechRecognizer', 'SVSFVoiceMask',
    'SDTAudio', 'SAFT12kHz16BitMono', 'SPEI_SOUND_START',
    'DISPID_SRCAudioInInterferenceStatus', 'SAFTADPCM_22kHzStereo',
    'SpeechDisplayAttributes', 'SpeechRegistryLocalMachineRoot',
    'SAFTExtendedAudioFormat', 'DISPID_SRSetPropertyNumber',
    'DISPID_SPEAudioSizeTime', 'DISPID_SLAddPronunciation',
    'SPEI_END_INPUT_STREAM', 'ISpPhoneConverter', 'DISPID_SLWWord',
    'DISPID_SRCEFalseRecognition', 'SpStreamFormatConverter',
    'SP_VISEME_20', 'DISPID_SVWaitUntilDone', 'eLEXTYPE_PRIVATE16',
    'SVSFIsXML', 'SPAO_RETAIN_AUDIO', 'SAFTADPCM_44kHzStereo',
    'SDTReplacement', 'SAFT32kHz8BitStereo', 'SAFT32kHz16BitStereo',
    'SAFTADPCM_22kHzMono', 'DISPID_SFSOpen',
    'DISPID_SpeechAudioStatus', 'SREPrivate', 'SBOPause',
    'SpeechBookmarkOptions', 'SVEViseme', 'SPINTERFERENCE_NOISE',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'ISpRecognizer2', 'DISPID_SPPBRestorePhraseFromMemory',
    'SREBookmark', 'STSF_FlagCreate', 'DISPID_SLWs_NewEnum',
    'SPSERIALIZEDRESULT', 'DISPID_SRCESoundStart', 'SPPHRASEELEMENT',
    'DISPID_SWFEBlockAlign', 'DISPID_SRGetRecognizers',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SRRAudioFormat',
    'ISpRecoCategory', 'ISpeechGrammarRules',
    'DISPID_SPISaveToMemory', 'DISPID_SADefaultFormat', 'ISpShortcut',
    'SVP_3', 'ISpeechLexiconPronunciations',
    'DISPID_SDKSetStringValue', 'DISPID_SVResume',
    'SpeechInterference', 'SITooSlow', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SPIEngineId', 'SPPS_Function', 'SAFTADPCM_8kHzStereo',
    'DISPID_SPRNumberOfElements', 'SAFT48kHz8BitMono',
    'SpeechPartOfSpeech', 'SPEI_WORD_BOUNDARY',
    'DISPID_SGRAddResource', 'DISPID_SMSSetData', 'SPBO_PAUSE',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SGRSTTWord',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SRCESoundEnd',
    'eLEXTYPE_USER_SHORTCUT', 'ISpStream', 'SRATopLevel',
    'DISPID_SLGenerationId', '__MIDL_IWinTypes_0009',
    'DISPID_SVSpeakCompleteEvent', 'SAFTCCITT_ALaw_8kHzStereo',
    'SPEI_VOICE_CHANGE', 'SAFT24kHz16BitMono', 'DISPID_SVSPhonemeId',
    'DISPID_SGRsFindRule', 'eLEXTYPE_PRIVATE10', 'SP_VISEME_1',
    'SPEI_RESERVED1', 'DISPID_SBSSeek', 'SPAUDIOOPTIONS',
    'DISPID_SGRClear', 'ISpRecognizer3', 'eLEXTYPE_APP',
    'eLEXTYPE_PRIVATE7', 'ISpNotifySource', 'SpeechStreamFileMode',
    'SPAR_Medium', 'SAFT44kHz8BitMono', 'DISPID_SGRId',
    'DISPID_SGRsCommitAndSave', 'DISPID_SOTCreateInstance',
    'ISpEventSink', 'DISPID_SLGetPronunciations', 'SGRSTTTextBuffer',
    'ISpeechAudio', 'DISPID_SVAlertBoundary',
    'SpeechStreamSeekPositionType', 'DISPID_SpeechWaveFormatEx',
    'SSFMCreateForWrite', 'DISPID_SASetState', 'SPFM_CREATE_ALWAYS',
    'SAFTADPCM_8kHzMono', 'DISPID_SDKCreateKey', 'SGDisplay',
    'ISpRecoResult', 'SP_VISEME_19', 'DISPID_SpeechRecoContext',
    'SVF_Stressed', 'SVSFIsFilename', 'DISPID_SRCEventInterests',
    'SGSEnabled', 'SpNullPhoneConverter', 'SPWT_LEXICAL',
    'SAFT16kHz16BitStereo', 'SPGS_EXCLUSIVE', 'SAFTADPCM_11kHzMono',
    'DISPID_SVSpeakStream', 'SPWORDPRONOUNCEABLE',
    'SpeechCategoryRecoProfiles', 'DISPID_SBSRead', 'SPPARTOFSPEECH',
    'SPRST_NUM_STATES', 'SVF_None', 'DISPID_SVPause',
    'DISPID_SPILanguageId', 'SPFM_OPEN_READWRITE',
    'SpeechWordPronounceable',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SVP_19',
    'eLEXTYPE_PRIVATE13', 'SPSHT_OTHER',
    'DISPID_SRCRetainedAudioFormat', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SRCEEnginePrivate', 'DISPID_SABIBufferSize',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPVOICESTATUS', 'SVP_20',
    'SPPS_NotOverriden', 'SpeechRecoProfileProperties',
    'DISPID_SPCLangId', 'SpeechVisemeFeature',
    'DISPID_SVSLastStreamNumberQueued', 'SVSFPersistXML',
    'ISpeechRecoGrammar', 'SITooLoud', 'SPBINARYGRAMMAR', 'SVP_11',
    'SPCT_DICTATION', 'SAFT24kHz8BitMono', 'SAFTGSM610_11kHzMono',
    'ISpeechPhraseReplacements', 'DISPID_SRStatus',
    'DISPID_SRGetFormat', 'eLEXTYPE_RESERVED8', 'SpeechMicTraining',
    'DISPID_SPARecoResult', 'DISPID_SRIsShared', 'SVP_6',
    'tagSPPROPERTYINFO', 'DISPID_SPEDisplayText',
    'SAFT44kHz16BitStereo', 'SVP_0', 'SpeechTokenContext',
    'DISPID_SMSGetData', 'SpeechTokenValueCLSID', 'SVP_18',
    'SpShortcut', 'DISPID_SpeechFileStream', 'DISPID_SGRSTransitions',
    'SAFTCCITT_ALaw_22kHzMono', 'SPRS_ACTIVE', 'SPEI_REQUEST_UI',
    'DISPID_SRCERecognition', 'DISPID_SpeechObjectTokens',
    'ISpeechVoice', 'SpeechAudioProperties', 'SVSFParseAutodetect',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SLPsItem', 'tagSTATSTG',
    'SPPS_Unknown', 'SPEI_VISEME', 'eLEXTYPE_PRIVATE19',
    'SpeechTokenKeyAttributes', 'SVP_5', 'SVP_14', 'SLOStatic',
    'DISPID_SPEAudioStreamOffset', 'SGDSInactive', 'DISPID_SAFType',
    'ISpeechWaveFormatEx', 'SAFT8kHz16BitStereo', 'SAFT11kHz8BitMono',
    'DISPID_SPIGetDisplayAttributes', 'SRESoundStart',
    'DISPID_SRSCurrentStreamPosition', 'SECFEmulateResult',
    'DISPIDSPRG', 'SPSTREAMFORMATTYPE', 'SAFT8kHz16BitMono',
    'DISPID_SpeechBaseStream', 'DISPID_SGRSTPropertyName',
    'SpeechRuleState', 'ISpeechAudioFormat', 'SpeechEngineConfidence',
    'SpeechCategoryAppLexicons', 'SPRST_ACTIVE_ALWAYS', 'SPPS_Verb',
    'DISPID_SPCPhoneToId', 'SPWORD', 'SAFT32kHz8BitMono', 'SASClosed',
    'DISPID_SGRSTPropertyId', 'SRCS_Disabled', 'DISPID_SPEsItem',
    'DISPID_SGRsDynamic', 'Speech_StreamPos_RealTime',
    'SPRS_INACTIVE', 'SP_VISEME_3', 'SpeechVoicePriority',
    'DISPID_SPRulesItem', 'SPAS_STOP', 'DISPID_SGRSTs_NewEnum',
    '_RemotableHandle', 'ISpeechPhraseRules', 'SPRECORESULTTIMES',
    'DISPID_SPPFirstElement', 'ISpeechLexiconWords',
    'DISPID_SPPsCount', 'DISPID_SRRPhraseInfo',
    'SSSPTRelativeToStart', 'SpPhoneConverter', 'SAFT32kHz16BitMono',
    'DISPID_SRGCmdLoadFromMemory', 'ISpSerializeState',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SP_VISEME_11',
    'DISPID_SOTMatchesAttributes', 'SpMMAudioIn',
    'DISPID_SASCurrentSeekPosition', 'SRTReSent',
    'SpeechRecognizerState', 'SVSFParseSsml', 'DISPID_SVSpeak',
    'DISPID_SRGSetTextSelection', 'SVSFNLPSpeakPunc',
    'DISPID_SOTGetAttribute', 'DISPID_SpeechPhraseRule',
    'DISPID_SLPPartOfSpeech', 'DISPID_SRRTOffsetFromStart',
    'SPSFunction', 'ISpeechPhraseInfo', 'SPLEXICONTYPE',
    'DISPID_SRCCreateGrammar', 'DISPID_SBSWrite', 'SP_VISEME_10',
    'DISPID_SRRTStreamTime', 'SVEBookmark', 'WAVEFORMATEX',
    'SDKLCurrentUser', 'SPGRAMMARSTATE', 'SPEI_SR_RETAINEDAUDIO',
    'SRSInactiveWithPurge', 'SpeechPropertyHighConfidenceThreshold',
    'SREInterference', 'SPDKL_DefaultLocation',
    'DISPID_SpeechLexiconWords', 'DISPID_SpeechGrammarRule',
    'DISPID_SRRTimes', 'SPEI_START_INPUT_STREAM', 'SBONone',
    'ISpXMLRecoResult', 'SAFT22kHz8BitStereo',
    'DISPID_SAFSetWaveFormatEx', 'SP_VISEME_15',
    'DISPID_SABIEventBias', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SVPriority', 'SVSFPurgeBeforeSpeak', 'DISPID_SDKOpenKey',
    'SP_VISEME_4', 'SREStreamEnd', 'STSF_LocalAppData',
    'DISPID_SpeechVoiceEvent', 'SREStateChange', 'SGLexical',
    'SpeechAddRemoveWord', 'SVESentenceBoundary', 'DISPID_SRRTLength',
    'SINone', 'DISPID_SLPPhoneIds', 'SAFT8kHz8BitStereo',
    'DISPID_SpeechAudio', 'SPWF_SRENGINE',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SpeechDataKey',
    'DISPID_SPIReplacements', 'ISpeechLexicon', 'SpeechAudioVolume',
    'Speech_Max_Word_Length', 'SPLOADOPTIONS', 'SPRECOCONTEXTSTATUS',
    'DISPID_SPRuleFirstElement', 'SAFT24kHz8BitStereo',
    'DISPID_SLPLangId', 'SPPS_SuppressWord', 'DISPID_SDKDeleteValue',
    'SRADynamic', 'SPGS_ENABLED', 'DISPID_SpeechPhraseAlternate',
    ...
    'SPFM_CREATE', 'ISpLexicon', 'SVSFNLPMask',
    ...
    'DISPID_SOTsItem', 'DISPID_SGRsCommit', 'SVPNormal',
    'SPEI_SR_PRIVATE', 'eLEXTYPE_VENDORLEXICON', 'SpSharedRecognizer',
    'SPSHORTCUTTYPE', 'ISpeechMMSysAudio', 'SPINTERFERENCE_TOOLOUD',
    'ISpeechPhraseElement',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SpeechAudioFormat', 'DISPID_SRCEPropertyStringChange',
    'SpeechWordType', 'DISPID_SLGetGenerationChange',
    'eLEXTYPE_PRIVATE20', 'DISPID_SRCEAudioLevel',
    'DISPID_SWFEAvgBytesPerSec', 'SRAONone', 'eLEXTYPE_PRIVATE3',
    'SRSActive', 'DISPID_SRProfile', 'ISpProperties',
    'DISPID_SPEDisplayAttributes', 'SECFDefault',
    'DISPID_SVSRunningState', 'DISPID_SVRate',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SRCVoice',
    'SECFNoSpecialChars', 'SPRULESTATE', 'eLEXTYPE_PRIVATE8',
    'DISPID_SLPType', 'SPEI_PHRASE_START', 'SVEWordBoundary',
    'SECFIgnoreWidth', 'SSFMOpenReadWrite', 'DISPID_SRRRecoContext',
    'SPCS_DISABLED', 'SREPropertyStringChange', 'ISpNotifyTranslator',
    'SpeechGrammarWordType', '_ISpeechVoiceEvents',
    'SAFT44kHz16BitMono', 'DISPID_SDKGetStringValue',
    'DISPID_SPPName', 'SAFT16kHz8BitStereo', 'DISPID_SVEViseme',
    'SRERequestUI', 'DISPID_SPRsCount', 'SPCT_COMMAND',
    'DISPID_SpeechGrammarRuleState', 'SWPUnknownWordUnpronounceable',
    'ISpeechDataKey', 'SECFIgnoreKanaType',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SpeechLexiconWord',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SLWType',
    'SECNormalConfidence', 'SpeechTokenIdUserLexicon',
    'STCLocalServer', 'DISPID_SGRsItem', 'SPEI_MIN_TTS',
    'DISPID_SPEActualConfidence', 'DISPID_SRSClsidEngine',
    'SVEStartInputStream', 'SSSPTRelativeToEnd', 'DISPIDSPTSI',
    'DISPID_SPIEnginePrivateData', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SRGRecoContext', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SLTUser', 'SREAdaptation',
    'SpeechGrammarRuleStateTransitionType', 'SPEI_TTS_BOOKMARK',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SMSAMMHandle', 'SRARoot',
    'ISpPhrase', 'SVP_1', 'ISpeechGrammarRuleState',
    'DISPID_SRCERecognizerStateChange', 'SPCONTEXTSTATE',
    'DISPID_SRAudioInputStream', 'SDA_One_Trailing_Space', 'SPPS_LMA',
    'SAFT16kHz8BitMono', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SPERetainedStreamOffset', 'SpInProcRecoContext',
    'DISPID_SOTGetDescription', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SVSVisemeId', 'DISPID_SLWsCount',
    'DISPID_SPRuleNumberOfElements', 'SpeechCategoryAudioIn',
    'SAFT22kHz16BitMono', 'SpeechLoadOption', 'SAFTText',
    'SRSEIsSpeaking', 'SpeechGrammarTagDictation', 'DISPID_SRState',
    'DISPID_SRCCmdMaxAlternates',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'eLEXTYPE_RESERVED4',
    'SpeechGrammarTagWildcard', 'DISPID_SDKGetBinaryValue',
    'DISPID_SPRs_NewEnum', 'SAFTDefault', 'DISPID_SVAudioOutput',
    'DISPID_SVVoice', 'DISPID_SPRuleConfidence', 'SPLO_STATIC',
    'SPEI_RESERVED5', 'SPSEMANTICERRORINFO', 'SPBOOKMARKOPTIONS',
    'DISPID_SpeechVoiceStatus', 'ISpeechLexiconPronunciation',
    'eLEXTYPE_RESERVED9', 'SAFT22kHz16BitStereo', 'SPLO_DYNAMIC',
    'SPVPRI_ALERT', 'DISPID_SpeechLexicon', 'DISPID_SGRSTsCount',
    'ISpeechAudioBufferInfo', 'ISpeechObjectTokenCategory',
    'SpResourceManager', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SPXRO_SML', 'LONG_PTR', 'DISPID_SPERequiredConfidence',
    'SP_VISEME_13', 'SpeechUserTraining', 'SPAR_Unknown',
    'eLEXTYPE_PRIVATE17', 'SAFT48kHz16BitMono', 'SPEI_SR_AUDIO_LEVEL',
    'SVSFDefault', 'SDA_Consume_Leading_Spaces', 'SPSNoun',
    'SpCompressedLexicon', 'SpStream', 'SDTDisplayText', 'SPCT_SLEEP',
    'SPPHRASEPROPERTY', 'SPEI_END_SR_STREAM', 'SVP_4',
    'SAFT22kHz8BitMono', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SRCEAdaptation', 'DISPID_SPRsItem', 'DISPID_SRCState',
    'SPXMLRESULTOPTIONS', 'DISPID_SVEStreamStart',
    'DISPID_SABufferInfo', 'DISPID_SBSFormat',
    'ISpStreamFormatConverter', 'SPCT_SUB_DICTATION', 'SP_VISEME_14',
    'SAFTCCITT_ALaw_22kHzStereo', 'SpeechVisemeType',
    'Speech_Default_Weight', 'DISPID_SpeechRecoResultTimes',
    'SWTAdded', 'SPAUDIOSTATUS', 'SAFT16kHz16BitMono', 'SP_VISEME_12',
    'SpFileStream', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SRRTTickCount', 'DISPID_SVGetAudioOutputs',
    'Speech_StreamPos_Asap', 'DISPID_SMSALineId',
    'SPINTERFERENCE_NONE', 'ISpeechFileStream',
    'Speech_Max_Pron_Length', 'SRAInterpreter', 'SpVoice',
    'SGRSTTRule', 'SPWORDTYPE', 'SpeechCategoryRecognizers',
    'SpeechAudioFormatType', 'SGRSTTDictation', 'DISPID_SOTCSetId',
    'SPDKL_CurrentUser', 'DISPID_SRRSetTextFeedback',
    'SpeechPropertyAdaptationOn', 'DISPID_SpeechMMSysAudio',
    'ISpeechRecoResultDispatch', 'SRADefaultToActive',
    'DISPID_SRRGetXMLErrorInfo', 'SPDATAKEYLOCATION',
    'ISpObjectTokenCategory', 'ISpResourceManager',
    'DISPID_SpeechCustomStream', 'DISPID_SPIAudioSizeTime',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SOTsCount',
    'DISPID_SAVolume', 'SPVPRI_NORMAL', 'ISpeechXMLRecoResult',
    'SPINTERFERENCE_LATENCY_WARNING', 'SLTApp', 'SREPhraseStart',
    'SP_VISEME_7', 'SP_VISEME_16', 'DISPID_SAFGuid', 'SPSHORTCUTPAIR',
    'SPWORDPRONUNCIATION', 'SpeechDiscardType', 'SPEI_PHONEME',
    'ISpPhoneticAlphabetConverter', 'DISPID_SDKSetLongValue',
    'ISpRecoContext2', 'SPSHT_Unknown', 'SPDKL_CurrentConfig',
    'eLEXTYPE_PRIVATE12', 'DISPID_SPPChildren', 'SpeechAudioState',
    'SpeechPropertyResponseSpeed', 'SPVPRI_OVER', 'SPPS_RESERVED1',
    'SAFTADPCM_44kHzMono', 'SPSLMA', 'SpeechAllElements',
    'ISpeechPhraseRule', 'SSTTDictation', 'DISPID_SPEsCount',
    'ISpAudio', 'SAFT8kHz8BitMono', 'SVPAlert', 'DISPID_SMSADeviceId',
    'DISPID_SpeechPhraseProperties', 'SPPS_RESERVED3',
    ...
    'SAFTADPCM_11kHzStereo', 'ISpeechObjectTokens',
    'DISPID_SRRecognizer', 'SP_VISEME_8', 'ISpeechResourceLoader',
    'SVEVoiceChange', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SGRSTWeight', 'SPSUnknown', 'ISpRecognizer',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SVSCurrentStreamNumber',
    'SRSInactive', 'DISPID_SVSkip', 'SAFTGSM610_8kHzMono',
    'SVEPrivate', 'DISPID_SRCCreateResultFromMemory', 'SVSFlagsAsync',
    'eLEXTYPE_PRIVATE1', 'SAFTCCITT_uLaw_11kHzMono',
    'SGDSActiveUserDelimited', 'SWPKnownWordPronounceable',
    'SpeechVoiceSpeakFlags', 'SP_VISEME_21',
    'DISPID_SpeechGrammarRules', 'DISPID_SPPId', 'SPAS_CLOSED',
    'DISPID_SPPNumberOfElements', 'DISPID_SRGetPropertyString',
    'DISPID_SRGDictationSetState', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SPIRule', 'SVP_13', 'DISPID_SVEWord',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SOTs_NewEnum',
    'DISPID_SPRuleId', 'DISPID_SRCreateRecoContext',
    'DISPID_SVSyncronousSpeakTimeout', 'SGDSActiveWithAutoPause',
    'DISPID_SPRuleChildren', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SPAs_NewEnum', 'ISpeechPhraseElements',
    'ISpeechTextSelectionInformation', 'SpeechPropertyResourceUsage',
    'ISpDataKey', 'SVF_Emphasis', 'SINoSignal', 'SPEI_MAX_TTS',
    'SDTPronunciation', 'DISPID_SWFEExtraData',
    'DISPID_SWFESamplesPerSec', 'DISPID_SPCIdToPhone',
    'SRERecognition', 'SREAllEvents', 'ISpNotifySink',
    'SVSFUnusedFlags', 'SPWORDLIST', 'DISPID_SPELexicalForm',
    'SPCT_SUB_COMMAND', 'DISPID_SOTRemoveStorageFileName',
    'SPAS_PAUSE', 'SAFT12kHz8BitStereo', 'DISPID_SPEPronunciation',
    'SpeechFormatType', 'SpeechRecoContextState',
    'DISPID_SVEAudioLevel', 'DISPID_SRGState',
    'DISPID_SpeechRecoResult2', 'DISPID_SVGetVoices', 'SRTEmulated',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SPEAudioSizeBytes',
    'SGSDisabled', 'SPEI_SOUND_END', 'SVP_7',
    'DISPID_SLWPronunciations', 'SPDKL_LocalMachine', 'SGRSTTEpsilon',
    'DISPID_SPIProperties', 'SFTInput', 'DISPID_SVAudioOutputStream',
    'DISPID_SRCRecognizer', 'SVP_10', 'SPINTERFERENCE_TOOSLOW',
    'SVSFIsNotXML', 'SpeechDataKeyLocation', 'SpeechRuleAttributes',
    'SAFT24kHz16BitStereo', 'DISPID_SRDisplayUI', 'SPSVerb',
    'ISpeechGrammarRule', 'ISpeechPhraseReplacement', 'SP_VISEME_9',
    'DISPID_SGRSTPropertyValue', 'SREFalseRecognition',
    'DISPID_SRGReset', 'DISPID_SPRText', 'SAFT12kHz16BitStereo',
    'DISPID_SGRsCount', 'SPRECOSTATE', 'SP_VISEME_5', 'SPRULE',
    'ISpeechPhraseProperties', 'DISPID_SVEPhoneme', 'SREHypothesis',
    'DISPID_SPACommit', 'SAFT12kHz8BitMono', 'SPEI_SR_BOOKMARK',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SDKEnumKeys',
    'DISPID_SGRAttributes', 'eLEXTYPE_PRIVATE18',
    'DISPID_SpeechRecoResult', 'SRSEDone', 'DISPID_SAStatus',
    'ISpeechPhoneConverter', 'STCAll', 'SSTTWildcard',
    'ISpeechPhraseInfoBuilder', 'SRESoundEnd', 'SASRun',
    'eLEXTYPE_PRIVATE4', 'DISPID_SASNonBlockingIO',
    'DISPID_SCSBaseStream', 'DISPID_SVIsUISupported',
    'SPEI_INTERFERENCE', 'SSTTTextBuffer', 'SLODynamic',
    'eLEXTYPE_PRIVATE14', 'SASStop', 'SAFTNoAssignedFormat',
    'DISPID_SPIElements', 'SREStreamStart', 'DISPID_SRCPause',
    'SPEI_RECO_OTHER_CONTEXT', 'ISpeechPhraseAlternate', 'SSFMCreate',
    'eWORDTYPE_DELETED', 'SpMMAudioEnum', 'DISPID_SRCERequestUI',
    'DISPID_SPIGrammarId', '_ISpeechRecoContextEvents',
    'SpNotifyTranslator', 'DISPID_SRRAlternates', 'SPEVENT',
    'DISPID_SRCEEndStream', 'DISPID_SOTCId',
    'DISPID_SOTIsUISupported', 'DISPID_SRGId', 'SpCustomStream',
    'DISPID_SRGetPropertyNumber', 'DISPID_SRCEStartStream',
    'DISPID_SREmulateRecognition', 'SpMemoryStream',
    'eLEXTYPE_PRIVATE6', 'SAFT11kHz16BitStereo', 'STSF_AppData',
    'SGDSActive', 'ISpeechRecoResult', 'SVP_8', 'SVEPhoneme',
    'eLEXTYPE_MORPHOLOGY', 'SPTEXTSELECTIONINFO', 'SPPS_Noun',
    'DISPID_SDKGetlongValue',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SRRAudio',
    'ISpeechPhraseAlternates', 'eLEXTYPE_RESERVED10'
]
